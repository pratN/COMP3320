...
public class ShadowBox {
	...
	protected void update() {
		...
		toNear.scale(MasterRenderHandler.NEAR_PLANE);
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (SHADOW_DISTANCE * Math.tan(Math.toRadians(MasterRenderHandler.FOV)));
		nearWidth = (float) (MasterRenderHandler.NEAR_PLANE
				* Math.tan(Math.toRadians(MasterRenderHandler.FOV)));
	...
	private float getAspectRatio() {
		return (float) WindowHandler.getWidth() / (float) WindowHandler.getHeight();
	}
